// UnternehmenProfilPage
// Route: /unternehmen/profil
...
export default function UnternehmenProfilPage() {
    ...
    <AppShell maxWidth={800}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 14, color: '#94a3b8', fontFamily: F }}>
          Pflegen Sie Ihre Unternehmensinformationen für Kandidaten und das Admin-Team.
        </p>
      </div>
      <CompanyProfileForm />
    </AppShell>
