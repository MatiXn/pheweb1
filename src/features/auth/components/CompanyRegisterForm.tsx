    ...
    >
      <div style={{ width: '100%', maxWidth: 440 }}>
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ marginTop: 8, fontSize: 15, color: C.muted }}>Als Unternehmen registrieren</p>
        </div>
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            <input
              ...
              style={errors.companyName ? INP_ERROR : { ...INP_BASE, marginBottom: 4 }}
            ...
            {!errors.companyName && <div style={{ marginBottom: 12 }} />}
